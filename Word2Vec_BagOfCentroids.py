...
if __name__ == '__main__':
    ...
    scores_accuracy = cross_val_score(forest, train_centroids, train["sentiment"], cv=5)
    scores_precision = cross_val_score(forest, train_centroids, train["sentiment"], cv=5, scoring='precision')
    scores_recall = cross_val_score(forest, train_centroids, train["sentiment"], cv=5, scoring='recall')
